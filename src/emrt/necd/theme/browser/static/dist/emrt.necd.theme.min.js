...
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! moment */ "./node_modules/.pnpm/moment@2.29.4/node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_0__);

function hightlight_restructured() {
    var elBody = $("body");
    if (elBody.hasClass("template-emrt-necd-content-observation") ||
...
$(function () {
    ...
    $(".datetimeWF").each(function () {
        ...
        var timeAgo = moment__WEBPACK_IMPORTED_MODULE_0__(time, "YYYY/MM/DD HH:mm:ss").format("YYYY/MM/DD HH:mm:ss");
        var timeZone = time.substring(time.indexOf("+") + 1);
        timeAgo += " +0" + timeZone + ":00";
        $(this).text(moment__WEBPACK_IMPORTED_MODULE_0__(timeAgo, "YYYY/MM/DD HH:mm:ss Z").fromNow());
    });
